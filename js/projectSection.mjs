document.addEventListener('DOMContentLoaded', () => {
    ...
    const projects = {
        project1: {
            ...
            description: "",
            images: ["/assets/projects/game-hub-hero.png"],
            links: ["https://taraolivia.github.io/GameHub-taraolivia-js_integration/index.html"],
            backgroundImage: "/assets/projects/hero-image-game-hub.jpg"
        },
        project2: {
            ...
            images: ["/assets/projects/galaxy-garden-hero.png"],
            links: ["https://taraolivia.github.io/semester-project-tara-bjorheim/index.html"],
            backgroundImage: "/assets/projects/galaxy-garden-background.png" 
        },
        project3: {
            title: "Project 3",
            ...
            backgroundImage: "/assets/background/project3-bg.jpg"
        },
        project4: {
            title: "Project 4",
            description: "Description for project 3",
